...
class Calculator:
    def __init__(self):
        self.window = tk.Tk()
        self.window.geometry('375x667')# this size is for Iphone8
...
# Expand buttons so that they fill the entire space
    ...
    def create_display_frame(self):
        ...
        frame.pack(expand=True,fill='both')# both?
        return frame
    ...
    def update_label(self):
        # avoid the result overflows the screen
    ...
    def evaluate(self):
        self.total_expression += self.current_expression
        self.update_total_label()
        # Handling the Exception like ZeroDivisionError
        try:
